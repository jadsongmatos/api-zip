...
export default function Ads() {
  return (
    <div className="container">
      ...
      <Script id="adaround" strategy="lazyOnload">
      ...
      <div
        ...
        data-options="fallback_rate=0.5"
        data-zone="177aafab44374b74a9d4c50d186d95ab"
        style={{
          height: "600px",
          display: "inline-block",
        }}
      >
        <style type="app/backfill">place here custom fallback code</style>
      </div>
    </div>
  );
}
